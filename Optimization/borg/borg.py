...
class Borg:
    ...
    def __init__(self, numberOfVariables, numberOfObjectives, numberOfConstraints, 
                 function, epsilons=None, bounds=None, directions=None,
        ...
        additional_inputs   - Additional inputs necessary for the optimization problem
        """
        ...
        if additional_inputs is None:
            ...
            self.function = _functionWrapper(function, numberOfVariables, numberOfObjectives, numberOfConstraints,
                                             directions, addl_inputs=additional_inputs)
...
def _functionWrapper(function, numberOfVariables, numberOfObjectives, 
                     numberOfConstraints, directions=None,
                     addl_inputs=None):
    ...
    addl_inputs - The array of additional inputs
    """
