#!/bin/bash
#SBATCH -D /scratch/jdq6nn/Lake_Problem_DPS/Optimization/Intertemporal/	# working directory
#SBATCH -o /scratch/jdq6nn/Lake_Problem_DPS/Optimization/Intertemporal/job.%j.%N.out   # Name of the output file (eg. myMPI.oJobID)
