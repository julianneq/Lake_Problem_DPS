#!/bin/bash
#SBATCH -D /scratch/js4yd/LakeProblem/Optimization/Intertemporal/
#SBATCH -o /scratch/js4yd/LakeProblem/Optimization/Intertemporal/output/job.%j.%N.out   # Name of the output file (eg. myMPI.oJobID)
